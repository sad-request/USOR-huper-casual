...
public class rotate_3_lvl : MonoBehaviour
{
  ...
  void all_rot_check () {
     ...
     //  Debug.Log (global.partChecker);
      ...
      check_rot180(obj5, "1_5");
     //  Debug.Log (global.partChecker);
      check_rot270(obj6, "1_6");
     // Debug.Log (global.partChecker);
      check_rot180(obj7, "1_7");
     // Debug.Log (global.partChecker);
      check_rot270(obj8, "1_8");
     //  Debug.Log (global.partChecker);

      check_rot90(obj9, "1_9");
     // Debug.Log (global.partChecker);
      check_rot180(obj10, "1_10");
     // Debug.Log (global.partChecker);
      check_rot90(obj11, "1_11");
     // Debug.Log (global.partChecker);
      check_rot0(obj12, "1_12");
     // Debug.Log (global.partChecker);
  ...
  public void OnClick() { 
    ...
    if (global.partChecker==16){
        ...
        // if (transform.rotation == target180){}
