...
public class rotate_with_handle_8_lvl : MonoBehaviour
{
  ...
  void all_rot_check () {
     ...
     // Debug.Log (global.partChecker);
      check_rot90(obj3, "1_3");
     // Debug.Log (global.partChecker);
      check_rot180(obj4, "1_4");
     //  Debug.Log (global.partChecker);
     ...
     // Debug.Log (global.partChecker);
      check_rot90(obj8, "1_8");
     //  Debug.Log (global.partChecker);

      check_rot270(obj9, "1_9");
     // Debug.Log (global.partChecker);
     ...
     // Debug.Log (global.partChecker);
      ...
      check_rot180(obj13, "1_13");
     //  Debug.Log (global.partChecker);
      check_rot270(obj14, "1_14");
      // Debug.Log (global.partChecker);
