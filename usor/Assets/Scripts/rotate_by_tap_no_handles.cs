...
public class rotate_by_tap_no_handles : MonoBehaviour
{
 ...
 // Quaternion target0 = Quaternion.Euler(0f, 0f, 0f);
  //Quaternion target90 = Quaternion.Euler(0f, 0f, -90f);
 // Quaternion target180 = Quaternion.Euler(0f, 0f, 180f);
  //Quaternion target270 = Quaternion.Euler(0f, 0f, 90f);
